...
import FilterBar from '../components/FilterBar'; // <--- НОВЫЙ ИМПОРТ ВЫНЕСЕННОГО КОМПОНЕНТА
...
    background: '#242424', // Темный фон для блоков (был #FFFFFF)
    pageBackground: '#131313', // Темный фон страницы (был #F7F7F7)
    border: '#444444',      // Темно-серый для границ
    shadow: 'rgba(0, 0, 0, 0.3)', // Более заметная тень для темного фона
    textPrimary: '#f0f0f0', // Светлый текст (был #1A1A1A)
    textSecondary: '#bbbbbb', // Серый светлый текст (был #555555)
    textMuted: '#888888',   // Бледный текст/идентификаторы (был #999999)
};
...
// ======================= МЕЛКИЕ КОМПОНЕНТЫ =======================
// === УДАЛЕННЫЙ КОМПОНЕНТ FilterBar БЫЛ ЗДЕСЬ ===
...
                
                <FilterBar // <--- ИСПОЛЬЗУЕМ ИМПОРТИРОВАННЫЙ КОМПОНЕНТ
                    filters={filters} 
                    setFilters={setFilters} 
                    cars={allCars} // <-- Пропс для фильтрации данных
                    models={modelsGrouped} // <-- Пропс для выпадающего списка моделей
...
        // Фон содержимого страницы должен быть темным, чтобы гармонировать
        // с общим фоном, либо можно оставить прозрачным для видимости градиента,
        // но тогда нужно обернуть все элементы в контейнер.
        // В данном случае, чтобы сохранить структуру, обновим стили для вложенных элементов.
        // Убираем padding-top, так как он уже есть в page.
        paddingBottom: '40px',
        paddingTop: '0', 
        
    },
...
        alignItems: 'center', 
        gap: '15px', 
        backgroundColor: COLORS.background, // Используем темный фон
...
        height: '40px', 
        objectFit: 'contain', 
        backgroundColor: '#333333', // Немного темнее для контраста с фоном
        borderRadius: '8px' 
    },
    pageTitleText: { 
        fontSize: '32px',
...
    typeButton: { 
        padding: '10px 20px', 
        backgroundColor: COLORS.background, // Темный фон кнопки
        color: COLORS.primary, 
        border: 'none', 
        cursor: 'pointer', 
        fontWeight: '500', 
...
        color: 'white', // Убедимся, что цвет текста белый на красном фоне
        fontWeight: '600' 
    },
    resetButton: { 
...
        color: COLORS.textPrimary, // Светлый текст
    },
    inputRangeContainer: { 
        display: 'flex', 
        gap: '0', 
